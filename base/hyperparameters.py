...
class Hyperparameters:
        def __init__(self):
            ...
            self.height = None #The height of the image (The distance from the top to the bottom)
            self.width = None   #The width of the image (The distance between the two sides of the image)
            self.channels = None #Number of channels in the image. Ex.: for a RGB image this number must be "3", for a grayscaled, "1".        
